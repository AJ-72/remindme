...
- **Clock time**: "X മണിക്ക്" (at X o'clock), where X is a digit run (Malayalam or Arabic numerals) or a spelled-out number word (ഒന്ന്–പന്ത്രണ്ട്, 1–12 — see Numerals below). Period-of-day words disambiguate AM/PM when combined with an hour, or set a default hour when used alone (no explicit hour): രാവിലെ/morning → AM for hours 1–11, default 9 AM alone; ഉച്ചയ്ക്ക്/noon-early-afternoon → PM for hours 1–11, default 12 PM alone; വൈകിട്ട്/evening → PM for hours 1–11, default 6 PM alone; രാത്രി/night → PM for hours 1–11, default 9 PM alone. (Corrected from an earlier draft that incorrectly biased ഉച്ചയ്ക്ക് to AM — "ഉച്ചയ്ക്ക് 2 മണിക്ക്" means 2 PM, not 2 AM.) 12 is left as 12 (noon) under any period word, including രാത്രി — "X മണിക്ക്" reminders don't need to disambiguate midnight in v1. **No period word at all** (bare "X മണിക്ക്"): hours 1–7 default to PM, hours 8–11 default to AM, 12 stays as 12 PM (noon) — matching the casual-speech convention that "5 മണിക്ക്" without qualification almost always means 5 PM, not 5 AM.
